...
try:
    ...
    app.config['MYSQL_PASSWORD'] = 'Uterlox1'
    app.config['MYSQL_DB'] = 'sussing'
    print("ahuenno")
...
def register():
    ...
    'email' in request.form and 'address' in request.form and 'city' in request.form and \
    'country' in request.form and 'postalcode' in request.form and 'organisation' in request.form:
        username = request.form['username']
        password = request.form['password']
